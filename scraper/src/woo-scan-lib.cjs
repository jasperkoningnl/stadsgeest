...
const TERMEN = [
  ...
  { term: 'faillissement', gewicht: 3, re: /\b(faillissement|failliet|surs[eé]ance)\w*/gi,
    uitsluit: [/\b(indien|wanneer|ingeval|in geval)\b[^.]{0,160}(surs[eé]ance|faillissement)/i,
      ...
      /huurder[^.]{0,100}(failliet|surs[eé]ance)/i, /staking\s+(der|van de)\s+activiteiten[^.]{0,120}(failliet|surs[eé]ance)/i] },
  ...
  { term: 'ondermijning', gewicht: 2, re: /\b(ondermijning|ondermijnende\s+criminaliteit)\b/gi },
  { term: 'integriteit', gewicht: 3, re: /\bintegriteits(schending|onderzoek|melding)\w*/gi,
    uitsluit: [/overeenkomst[^.]{0,240}integriteitsschending/i, /integriteitsschending[^.]{0,160}(overeenkomst|screeningsresultaat)/i] },
  ...
  { term: 'ingebrekestelling', gewicht: 3, re: /\bingebrekestelling\w*/gi,
    uitsluit: [/aanmaning\s+(en\/)?of\s+ingebrekestelling/i, /waarschuwing\s*,\s*ingebrekestelling/i, /zonder\s+(enige\s+|nadere\s+)?(voorafgaande\s+)?ingebrekestelling/i, /na\s+ingebrekestelling/i, /na\s+ommekomst[^.]{0,80}ingebrekestelling/i, /sommatie[^.]{0,60}ingebrekestelling/i, /(partij|partijen|opdrachtgever|opdrachtnemer|cliënt)[^.]{0,240}ingebrekestelling/i, /(verplichtingen\s+niet\s+nakom|redelijke\s+termijn|tekortkoming)[^.]{0,240}ingebrekestelling/i, /schriftelijke\s+ingebrekestelling[^.]{0,120}gedetailleerd/i, /redelijke\s+termijn[\s\S]{0,220}ingebrekestelling/i, /boete[^.]{0,120}ingebrekestelling/i, /ingebrekestelling[^.]{0,80}(niet\s+tijdig|beslistermijn)/i, /(niet\s+tijdig|beslistermijn)[^.]{0,80}ingebrekestelling/i] },
  ...
  { term: 'schikking', gewicht: 2, re: /\bschikking(en|svoorstel)?\b/gi,
    uitsluit: [/ter\s+be-?\s*schikking/i] },
  ...
  { term: 'bibob', gewicht: 2, re: /\bbibob\b/gi,
    uitsluit: [/gerechtigd[^.]{0,160}integriteitsscreening[^.]{0,160}bibob/i] },
  { term: 'geheimhouding', gewicht: 1, re: /\bgeheimhouding\w*/gi,
    uitsluit: [/geheimhoudingsplicht\s+en\/of\s+een\s+verschoningsrecht/i, /geheimhoudings(verklaring|verplichting)/i, /artikel\s+\d+[.:]?\s*_?\s*geheimhouding/i, /\d+\.\s*\d+\s+geheimhouding/i, /(opdrachtgever|opdrachtnemer|cliënt|programmatuur)[^.]{0,240}geheimhouding/i, /serviceoproepen[^.]{0,160}geheimhouding/i, /geheimhouding\s+van\s+(de\s+)?persoonsgegevens/i, /wet\s+op\s+het\s+notarisambt/i] },
  { term: 'onrechtmatig', gewicht: 2, re: /\bonrechtmatig\w*/gi,
    uitsluit: [/onrechtmatige?\s+(gebruik|verwerking|toegang|passages?|passeert)/i, /tegen\s+verlies[^.]{0,80}onrechtmatig/i, /gehuurde[^.]{0,80}onrechtmatig\s+onder\s+zich/i] },
